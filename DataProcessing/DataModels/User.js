...
User.prototype.follow = function (other, callback) {
    this.node.createRelationshipTo(other.node, 'follows', {}, function (err, rel) {
        callback(err);
    });
};
...
User.get = function (screen_name, callback) {
    db.getNodeById(screen_name, function (err, node) {
        if (err) return callback(err);
